...
#      I have not been about to reproduce this on my local windows machine
...
#      an error loading the shared lib. 
#      I have not been about to reproduce this on my local windows machine
python -m unittest -v test_om_wrapper.TestOMWrapper
python -m unittest -v test_om_wrapper.TestOMWrapperMesh
