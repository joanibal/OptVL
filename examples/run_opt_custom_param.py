...
class GeometryParametrizationComp(om.ExplicitComponent):
    def setup(self):
        ...
        # Output variables
        self.add_output(
            "xles_out", shape_by_conn=True, copy_shape="xles_in", desc="Transformed x leading edge coordinates"
        )
        self.add_output(
            "yles_out", shape_by_conn=True, copy_shape="yles_in", desc="Transformed y leading edge coordinates"
        )
        self.add_output(
            "zles_out", shape_by_conn=True, copy_shape="zles_in", desc="Transformed z leading edge coordinates"
        )
