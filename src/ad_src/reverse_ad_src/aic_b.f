...
C------------ influence of z-image
     ...
     +                , 3)*temp_diff
                ...
                arg3_diff = 0.D0
                arg4_diff = 0.D0
                CALL SRDVELC_B(rc(1, i), rc_diff(1, i), rc(2, i), 
     +                         rc_diff(2, i), rc(3, i), rc_diff(3, i), 
     +                         rl(1, l1), rl_diff(1, l1), arg1, 
     +                         arg1_diff, arg2, arg2_diff, rl(1, l2), 
     +                         rl_diff(1, l2), arg3, arg3_diff, arg4, 
     +                         arg4_diff, betm, betm_diff, rcore, 
     ...
     +                       , rl(2, l2), rl_diff(2, l2), arg2, 
     +                       arg2_diff, betm, betm_diff, rcore, 
     +                       rcore_diff, vsrc, vsrc_diff, vdbl, 
     +                       vdbl_diff)
              zoff_diff = zoff_diff + arg2_diff + arg1_diff
