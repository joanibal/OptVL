...
C   gradient     of useful results: crtot cntot cdtot_al cltot_al
...
C                cntot_u cxtot_u_ba cytot_u_ba cztot_u_ba crtot_u_ba
C                cmtot_u_ba cntot_u_ba xnp sm bb rr
C GETFILE
C
C
C
...
C'  axial   vel. u', ' sideslip vel. v', '  normal  vel. w'
      ...
      ENDDO
      temp_diff1 = 2.0*cntot_u_ba_diff(6)/bref
      cntot_u_ba_diff(6) = 0.D0
      cntot_u_diff(6) = cntot_u_diff(6) + temp_diff1
      bref_diff = -(cntot_u(6)*temp_diff1/bref)
      temp_diff1 = dir*2.0*cntot_u_ba_diff(5)/cref
      cntot_u_ba_diff(5) = 0.D0
      cntot_u_diff(5) = cntot_u_diff(5) + temp_diff1
      cref_diff = -(cntot_u(5)*temp_diff1/cref)
      temp_diff1 = 2.0*cntot_u_ba_diff(4)/bref
      cntot_u_ba_diff(4) = 0.D0
      cntot_u_diff(4) = cntot_u_diff(4) + temp_diff1
      bref_diff = bref_diff - cntot_u(4)*temp_diff1/bref
      DO ii1=1,numax
        cmtot_u_diff(ii1) = 0.D0
      ENDDO
      temp_diff1 = dir*2.0*cmtot_u_ba_diff(6)/bref
      cmtot_u_ba_diff(6) = 0.D0
      cmtot_u_diff(6) = cmtot_u_diff(6) + temp_diff1
      bref_diff = bref_diff - cmtot_u(6)*temp_diff1/bref
      temp_diff1 = 2.0*cmtot_u_ba_diff(5)/cref
      cmtot_u_ba_diff(5) = 0.D0
      cmtot_u_diff(5) = cmtot_u_diff(5) + temp_diff1
      cref_diff = cref_diff - cmtot_u(5)*temp_diff1/cref
      temp_diff1 = dir*2.0*cmtot_u_ba_diff(4)/bref
      cmtot_u_ba_diff(4) = 0.D0
      cmtot_u_diff(4) = cmtot_u_diff(4) + temp_diff1
      bref_diff = bref_diff - cmtot_u(4)*temp_diff1/bref
      DO ii1=1,numax
        crtot_u_diff(ii1) = 0.D0
      ENDDO
      temp_diff1 = 2.0*crtot_u_ba_diff(6)/bref
      crtot_u_ba_diff(6) = 0.D0
      crtot_u_diff(6) = crtot_u_diff(6) + temp_diff1
      bref_diff = bref_diff - crtot_u(6)*temp_diff1/bref
      temp_diff1 = dir*2.0*crtot_u_ba_diff(5)/cref
      crtot_u_ba_diff(5) = 0.D0
      crtot_u_diff(5) = crtot_u_diff(5) + temp_diff1
      cref_diff = cref_diff - crtot_u(5)*temp_diff1/cref
      temp_diff1 = 2.0*crtot_u_ba_diff(4)/bref
      crtot_u_ba_diff(4) = 0.D0
      crtot_u_diff(4) = crtot_u_diff(4) + temp_diff1
      bref_diff = bref_diff - crtot_u(4)*temp_diff1/bref
      DO ii1=1,numax
        cztot_u_diff(ii1) = 0.D0
      ENDDO
      temp_diff1 = 2.0*cztot_u_ba_diff(6)/bref
      cztot_u_ba_diff(6) = 0.D0
      cztot_u_diff(6) = cztot_u_diff(6) + temp_diff1
      bref_diff = bref_diff - cztot_u(6)*temp_diff1/bref
      temp_diff1 = dir*2.0*cztot_u_ba_diff(5)/cref
      cztot_u_ba_diff(5) = 0.D0
      cztot_u_diff(5) = cztot_u_diff(5) + temp_diff1
      cref_diff = cref_diff - cztot_u(5)*temp_diff1/cref
      temp_diff1 = 2.0*cztot_u_ba_diff(4)/bref
      cztot_u_ba_diff(4) = 0.D0
      cztot_u_diff(4) = cztot_u_diff(4) + temp_diff1
      bref_diff = bref_diff - cztot_u(4)*temp_diff1/bref
      DO ii1=1,numax
        cytot_u_diff(ii1) = 0.D0
      ENDDO
      temp_diff1 = dir*2.0*cytot_u_ba_diff(6)/bref
      cytot_u_ba_diff(6) = 0.D0
      cytot_u_diff(6) = cytot_u_diff(6) + temp_diff1
      bref_diff = bref_diff - cytot_u(6)*temp_diff1/bref
      temp_diff1 = 2.0*cytot_u_ba_diff(5)/cref
      cytot_u_ba_diff(5) = 0.D0
      cytot_u_diff(5) = cytot_u_diff(5) + temp_diff1
      cref_diff = cref_diff - cytot_u(5)*temp_diff1/cref
      temp_diff1 = dir*2.0*cytot_u_ba_diff(4)/bref
      cytot_u_ba_diff(4) = 0.D0
      cytot_u_diff(4) = cytot_u_diff(4) + temp_diff1
      bref_diff = bref_diff - cytot_u(4)*temp_diff1/bref
      DO ii1=1,numax
        cxtot_u_diff(ii1) = 0.D0
      ENDDO
      temp_diff1 = 2.0*cxtot_u_ba_diff(6)/bref
      cxtot_u_ba_diff(6) = 0.D0
      cxtot_u_diff(6) = cxtot_u_diff(6) + temp_diff1
      bref_diff = bref_diff - cxtot_u(6)*temp_diff1/bref
      temp_diff1 = dir*2.0*cxtot_u_ba_diff(5)/cref
      cxtot_u_ba_diff(5) = 0.D0
      cxtot_u_diff(5) = cxtot_u_diff(5) + temp_diff1
      cref_diff = cref_diff - cxtot_u(5)*temp_diff1/cref
      temp_diff1 = 2.0*cxtot_u_ba_diff(4)/bref
      cxtot_u_ba_diff(4) = 0.D0
      cxtot_u_diff(4) = cxtot_u_diff(4) + temp_diff1
      bref_diff = bref_diff - cxtot_u(4)*temp_diff1/bref
      cntot_u_diff(3) = cntot_u_diff(3) - cntot_u_ba_diff(3)
      cntot_u_ba_diff(3) = 0.D0
      cntot_u_diff(2) = cntot_u_diff(2) - dir*cntot_u_ba_diff(2)
      cntot_u_ba_diff(2) = 0.D0
      cntot_u_diff(1) = cntot_u_diff(1) - cntot_u_ba_diff(1)
      cntot_u_ba_diff(1) = 0.D0
      cmtot_u_diff(3) = cmtot_u_diff(3) - dir*cmtot_u_ba_diff(3)
      cmtot_u_ba_diff(3) = 0.D0
      cmtot_u_diff(2) = cmtot_u_diff(2) - cmtot_u_ba_diff(2)
      cmtot_u_ba_diff(2) = 0.D0
      cmtot_u_diff(1) = cmtot_u_diff(1) - dir*cmtot_u_ba_diff(1)
      cmtot_u_ba_diff(1) = 0.D0
      crtot_u_diff(3) = crtot_u_diff(3) - crtot_u_ba_diff(3)
      crtot_u_ba_diff(3) = 0.D0
      crtot_u_diff(2) = crtot_u_diff(2) - dir*crtot_u_ba_diff(2)
      crtot_u_ba_diff(2) = 0.D0
      crtot_u_diff(1) = crtot_u_diff(1) - crtot_u_ba_diff(1)
      crtot_u_ba_diff(1) = 0.D0
      cztot_u_diff(3) = cztot_u_diff(3) - cztot_u_ba_diff(3)
      cztot_u_ba_diff(3) = 0.D0
      cztot_u_diff(2) = cztot_u_diff(2) - dir*cztot_u_ba_diff(2)
      cztot_u_ba_diff(2) = 0.D0
      cztot_u_diff(1) = cztot_u_diff(1) - cztot_u_ba_diff(1)
      cztot_u_ba_diff(1) = 0.D0
      cytot_u_diff(3) = cytot_u_diff(3) - dir*cytot_u_ba_diff(3)
      cytot_u_ba_diff(3) = 0.D0
      cytot_u_diff(2) = cytot_u_diff(2) - cytot_u_ba_diff(2)
      cytot_u_ba_diff(2) = 0.D0
      cytot_u_diff(1) = cytot_u_diff(1) - dir*cytot_u_ba_diff(1)
      cytot_u_ba_diff(1) = 0.D0
      cxtot_u_diff(3) = cxtot_u_diff(3) - cxtot_u_ba_diff(3)
      cxtot_u_ba_diff(3) = 0.D0
      cxtot_u_diff(2) = cxtot_u_diff(2) - dir*cxtot_u_ba_diff(2)
      cxtot_u_ba_diff(2) = 0.D0
      cxtot_u_diff(1) = cxtot_u_diff(1) - cxtot_u_ba_diff(1)
      ...
      bref_diff = bref_diff - cntot_rz*temp_diff0/bref
     ...
     +    cnsax_u_diff(k)
      ...
      cntot_diff = cntot_diff + ca*crsax_a_diff - sa*cnsax_a_diff
      sa_diff = sa_diff + dir*wrot_rx_diff(3) - cntot*cnsax_a_diff - 
     +  crtot*crsax_a_diff - rz*wrot_a_diff(3) - rx*wrot_a_diff(1) - dir
     +  *wrot_rz_diff(1) - wrot(1)*temp_diff
      crtot_diff = crtot_diff - ca*cnsax_a_diff - sa*crsax_a_diff
      ca_diff = ca_diff + cntot*crsax_a_diff - crtot*cnsax_a_diff + rx*
     +  wrot_a_diff(3) + dir*wrot_rz_diff(3) - rz*wrot_a_diff(1) + dir*
     +  wrot_rx_diff(1) + wrot(3)*temp_diff
