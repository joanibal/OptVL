...
C'  axial   vel. u', ' sideslip vel. v', '  normal  vel. w'
      ...
      cmtot_u_diff(3, 6) = cmtot_u_diff(3, 6) + temp_diff1
      bref_diff = -(cmtot_u(3, 6)*temp_diff1/bref)
      temp_diff1 = dir*2.0*cntot_u_ba_diff(5)/cref
      cntot_u_ba_diff(5) = 0.D0
      cmtot_u_diff(3, 5) = cmtot_u_diff(3, 5) + temp_diff1
      cref_diff = -(cmtot_u(3, 5)*temp_diff1/cref)
      temp_diff1 = 2.0*cntot_u_ba_diff(4)/bref
      cntot_u_ba_diff(4) = 0.D0
      cmtot_u_diff(3, 4) = cmtot_u_diff(3, 4) + temp_diff1
      bref_diff = bref_diff - cmtot_u(3, 4)*temp_diff1/bref
      temp_diff1 = dir*2.0*cmtot_u_ba_diff(6)/bref
      cmtot_u_ba_diff(6) = 0.D0
      cmtot_u_diff(2, 6) = cmtot_u_diff(2, 6) + temp_diff1
      bref_diff = bref_diff - cmtot_u(2, 6)*temp_diff1/bref
      temp_diff1 = 2.0*cmtot_u_ba_diff(5)/cref
      cmtot_u_ba_diff(5) = 0.D0
      cmtot_u_diff(2, 5) = cmtot_u_diff(2, 5) + temp_diff1
      cref_diff = cref_diff - cmtot_u(2, 5)*temp_diff1/cref
      temp_diff1 = dir*2.0*cmtot_u_ba_diff(4)/bref
      cmtot_u_ba_diff(4) = 0.D0
      cmtot_u_diff(2, 4) = cmtot_u_diff(2, 4) + temp_diff1
      bref_diff = bref_diff - cmtot_u(2, 4)*temp_diff1/bref
      temp_diff1 = 2.0*crtot_u_ba_diff(6)/bref
      crtot_u_ba_diff(6) = 0.D0
      cmtot_u_diff(1, 6) = cmtot_u_diff(1, 6) + temp_diff1
      bref_diff = bref_diff - cmtot_u(1, 6)*temp_diff1/bref
      temp_diff1 = dir*2.0*crtot_u_ba_diff(5)/cref
      crtot_u_ba_diff(5) = 0.D0
      cmtot_u_diff(1, 5) = cmtot_u_diff(1, 5) + temp_diff1
      cref_diff = cref_diff - cmtot_u(1, 5)*temp_diff1/cref
      temp_diff1 = 2.0*crtot_u_ba_diff(4)/bref
      crtot_u_ba_diff(4) = 0.D0
      cmtot_u_diff(1, 4) = cmtot_u_diff(1, 4) + temp_diff1
      bref_diff = bref_diff - cmtot_u(1, 4)*temp_diff1/bref
      DO ii1=1,numax
        DO ii2=1,3
      ...
      cftot_u_diff(3, 6) = cftot_u_diff(3, 6) + temp_diff1
      bref_diff = bref_diff - cftot_u(3, 6)*temp_diff1/bref
      temp_diff1 = dir*2.0*cztot_u_ba_diff(5)/cref
      cztot_u_ba_diff(5) = 0.D0
      cftot_u_diff(3, 5) = cftot_u_diff(3, 5) + temp_diff1
      cref_diff = cref_diff - cftot_u(3, 5)*temp_diff1/cref
      temp_diff1 = 2.0*cztot_u_ba_diff(4)/bref
      cztot_u_ba_diff(4) = 0.D0
      cftot_u_diff(3, 4) = cftot_u_diff(3, 4) + temp_diff1
      bref_diff = bref_diff - cftot_u(3, 4)*temp_diff1/bref
      temp_diff1 = dir*2.0*cytot_u_ba_diff(6)/bref
      cytot_u_ba_diff(6) = 0.D0
      cftot_u_diff(2, 6) = cftot_u_diff(2, 6) + temp_diff1
      bref_diff = bref_diff - cftot_u(2, 6)*temp_diff1/bref
      temp_diff1 = 2.0*cytot_u_ba_diff(5)/cref
      cytot_u_ba_diff(5) = 0.D0
      cftot_u_diff(2, 5) = cftot_u_diff(2, 5) + temp_diff1
      cref_diff = cref_diff - cftot_u(2, 5)*temp_diff1/cref
      temp_diff1 = dir*2.0*cytot_u_ba_diff(4)/bref
      cytot_u_ba_diff(4) = 0.D0
      cftot_u_diff(2, 4) = cftot_u_diff(2, 4) + temp_diff1
      bref_diff = bref_diff - cftot_u(2, 4)*temp_diff1/bref
      temp_diff1 = 2.0*cxtot_u_ba_diff(6)/bref
      cxtot_u_ba_diff(6) = 0.D0
      cftot_u_diff(1, 6) = cftot_u_diff(1, 6) + temp_diff1
      bref_diff = bref_diff - cftot_u(1, 6)*temp_diff1/bref
      temp_diff1 = dir*2.0*cxtot_u_ba_diff(5)/cref
      cxtot_u_ba_diff(5) = 0.D0
      cftot_u_diff(1, 5) = cftot_u_diff(1, 5) + temp_diff1
      cref_diff = cref_diff - cftot_u(1, 5)*temp_diff1/cref
      temp_diff1 = 2.0*cxtot_u_ba_diff(4)/bref
      cxtot_u_ba_diff(4) = 0.D0
      cftot_u_diff(1, 4) = cftot_u_diff(1, 4) + temp_diff1
      bref_diff = bref_diff - cftot_u(1, 4)*temp_diff1/bref
...
C end if
C---  
c           CALL PUSHREAL8ARRAY(wc_gam, 3*nvmax**2) wc_gam is unchanged
...
c           CALL POPREAL8ARRAY(wc_gam, 3*nvmax**2) wc_gam unchaged 
      CALL BUILD_AIC_B()
