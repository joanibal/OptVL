...
The publicly accessible versions of Vorlax lack scripting integration and gradients for gradient-based design.
...
\autoref{fig:opt}. show an optimization problem from the examples that highlights how to include OptVL in a larger OpenMDAO model. 
...
<!-- Tiwari flying V -->
Furthermore, other researchers have used OptVL when optimizing control surface sizes on a novel "flying V" aircraft [@Tiwari2025].
